"""Repeat utilities for rue tests."""
...
from rue.testing.models import RepeatModifier
    ...
    def __call__(
        ...
        *,
        ...
        def decorator(target: Any) -> Any:
            modifiers: list = getattr(target, "__rue_modifiers__", [])
            modifiers.append(modifier)
            target.__rue_modifiers__ = modifiers
            return target
