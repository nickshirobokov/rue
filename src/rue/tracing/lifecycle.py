"""Lifecycle management for OpenTelemetry tracing in Rue.
...
from rue.tracing.exporters import StreamingFileSpanExporter
...
def init_tracing(
    *,
    ...
    if trace_content is None:
        trace_content = os.environ.get("RUE_TRACE_CONTENT", "true").lower() == "true"
...
def get_tracer(name: str = "rue") -> trace.Tracer:
