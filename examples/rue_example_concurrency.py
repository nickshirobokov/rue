...
Run with different concurrency levels to see the difference:
    ...
    rue test examples/rue_example_concurrency.py

    # Concurrent with 5 workers - ~1.2 seconds
    rue test examples/rue_example_concurrency.py --concurrency 5

    # Unlimited concurrency (capped at 10) - ~0.6 seconds
    rue test examples/rue_example_concurrency.py --concurrency 0
"""
