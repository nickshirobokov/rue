...
Run with different concurrency levels to see the difference:
    ...
    rue run examples/test_example_concurrency.py

    # Concurrent with 5 workers - ~1.2 seconds
    rue run examples/test_example_concurrency.py --concurrency 5

    # Unlimited concurrency (capped at 10) - ~0.6 seconds
    rue run examples/test_example_concurrency.py --concurrency 0
"""
