...
cases = [
    rue.Case(sut_input_values={"query": "Privacy policy"}),
    rue.Case(sut_input_values={"query": "How do you store data?"}),
]
...
cases = [
    rue.Case(sut_input_values={"prompt": "Hello", "temperature": 0.5}),
    rue.Case(sut_input_values={"prompt": "Hi"}),
]
