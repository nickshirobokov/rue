...
OpenTelemetry persistence is configured through reporters. Add `OtelReporter` for local `.rue/traces` storage or implement `Reporter.on_trace_collected()` in a custom reporter.
